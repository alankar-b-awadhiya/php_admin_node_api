...
$pageTitle = 'Clientele';
$activeNav = 'clientele';
$pageScript = 'clientele.js';
include __DIR__ . '/../app/includes/header.php';
?>
<div class="page-header">
  <div>
    <h2>Our Clientele</h2>
    <p class="subtitle">Manage client logos, profiles and display order</p>
  </div>
  <div class="toolbar">
...
<div class="card" style="margin-bottom:18px;">
  <div class="card-body" style="padding:14px 16px;display:flex;gap:14px;flex-wrap:wrap;align-items:flex-end;">
    <div class="form-group" style="margin-bottom:0;flex:1;min-width:220px;">
      ...
      <input type="search" id="searchInput" placeholder="Search name, description, industry...">
    </div>
  ...
  <div class="table-wrap">
    <table>
      ...
      <tbody id="clientsTableBody">
        <tr><td colspan="7" class="table-empty">Loading clients…</td></tr>
      </tbody>
    </table>
  </div>
